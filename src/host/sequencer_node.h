...
public:
    ...
    static constexpr uint32_t kMaxActiveNotesPerInstance = 32;
...
private:
    ...
    void triggerNoteOn(uint32_t instance_idx, const NoteData& note, double start_beat, uint32_t sample_offset);
