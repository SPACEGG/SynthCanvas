...
const clap_plugin_descriptor *SinePlugin::descriptor() {
    static const char *features[] = {CLAP_PLUGIN_FEATURE_INSTRUMENT, "synthesizer", nullptr};
...
bool SinePlugin::activate(double sampleRate, uint32_t minFrameCount,
...
//--- Audio Ports
uint32_t SinePlugin::audioPortsCount(bool is_input) const noexcept { return is_input ? 0 : 1; }

bool SinePlugin::audioPortsInfo(uint32_t index, bool is_input,
...
//--- Note Ports
uint32_t SinePlugin::notePortsCount(bool is_input) const noexcept { return is_input ? 1 : 0; }

bool SinePlugin::notePortsInfo(uint32_t index, bool is_input,
