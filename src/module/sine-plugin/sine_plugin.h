...
namespace clap
{
    ...
    protected:
        ...
        bool audioPortsInfo(uint32_t index, bool is_input, clap_audio_port_info_t *info) const noexcept override;

        bool implementsNotePorts() const noexcept override { return true; }
        uint32_t notePortsCount(bool is_input) const noexcept override;
        bool notePortsInfo(uint32_t index, bool is_input, clap_note_port_info_t *info) const noexcept override;
