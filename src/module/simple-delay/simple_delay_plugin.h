...
{
    class SimpleDelayPlugin : public clap::helpers::Plugin<clap::helpers::MisbehaviourHandler::Terminate,
    ...
    public:
        ...
        bool activate(double sampleRate, uint32_t minFramesCount, uint32_t maxFramesCount) noexcept override;
        ...
        bool notePortsInfo(uint32_t index, bool isInput, clap_note_port_info *info) const noexcept override { return false; }
